  ...
  return (
    <div className='rounded-lg p-4 md:p-6 xl:p-6 lg:p-6'>
      ...
      <div className='flex gap-1 '>
        <FaRegArrowAltCircleLeft className='mt-1' /> <Link to={'/customers/transactions'} className="text-gray-800 hover:underline mb-4 inline-block">Back</Link>
      </div>
